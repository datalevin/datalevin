    ...
    (apply run "clojure"
           ...
           (cond
             ...
             (str "{:paths [\"src\"]"
                  ...
                  org.clojars.huahaiy/dtlvnative-windows-x86_64 {:mvn/version \"0.19.3\"}
                  org.clojars.huahaiy/dtlvnative-linux-x86_64 {:mvn/version \"0.19.3\"}
                  org.clojars.huahaiy/dtlvnative-linux-arm64 {:mvn/version \"0.19.3\"}
                  org.clojars.huahaiy/dtlvnative-macosx-arm64 {:mvn/version \"0.19.3\"}
                  }}"
                  )
