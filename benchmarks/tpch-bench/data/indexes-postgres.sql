-- TPC-H foreign-key indexes for PostgreSQL.
-- Primary keys already index the join columns; these cover the referencing
-- side of each declared relationship, matching the specification's dss.ri.
