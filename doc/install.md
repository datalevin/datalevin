...
```Clojure
{:deps {datalevin/datalevin {:mvn/version "0.10.13"}}}
```
...
```Clojure
{:deps {org.datalevin/datalevin-embedded {:mvn/version "0.10.13"}}}
```
...
* [MacOS](https://github.com/datalevin/datalevin/releases/download/0.10.13/dtlv-0.10.13-macos-14-aarch64.zip)
  on arm64 (AARCH64)
* [Linux](https://github.com/datalevin/datalevin/releases/download/0.10.13/dtlv-0.10.13-ubuntu-22.04-amd64.zip)
  on x86_64 (AMD64)
* [Linux](https://github.com/datalevin/datalevin/releases/download/0.10.13/dtlv-0.10.13-ubuntu-24.04-arm-aarch64.zip)
  on arm64 (AARCH64)
* [Windows](https://github.com/datalevin/datalevin/releases/download/0.10.13/dtlv-0.10.13-windows-amd64.zip)
  on x86-64 (AMD64)
...
A JVM
[uberjar](https://github.com/datalevin/datalevin/releases/download/0.10.13/datalevin-0.10.13-standalone.jar)
...
```console
java --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED -jar datalevin-0.10.13-standalone.jar
```
This will start the Datalevin REPL.

```console
java --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED -jar datalevin-0.10.13-standalone.jar serv -r /tmp/test-server
```
...
(pods/load-pod 'huahaiy/datalevin "0.10.13")
