...
test("public surface stays importable without starting the JVM", () => {
  ...
  assert.equal(typeof datalevin.createAnalyzer, "function");
  assert.equal(typeof datalevin.createMaxLengthTokenFilter, "function");
  assert.equal(typeof datalevin.createMinLengthTokenFilter, "function");
  assert.equal(typeof datalevin.createNgramTokenFilter, "function");
  assert.equal(typeof datalevin.createRegexpTokenizer, "function");
  assert.equal(typeof datalevin.createStemmingTokenFilter, "function");
  assert.equal(typeof datalevin.createStopWordsTokenFilter, "function");
  assert.equal(typeof datalevin.createUdfRegistry, "function");
  assert.equal(typeof datalevin.datom, "function");
  assert.equal(typeof datalevin.datomA, "function");
  assert.equal(typeof datalevin.datomAdded, "function");
  assert.equal(typeof datalevin.datomE, "function");
  assert.equal(typeof datalevin.datomIs, "function");
  assert.equal(typeof datalevin.datomTx, "function");
  assert.equal(typeof datalevin.datomV, "function");
  assert.equal(typeof datalevin.datalogKv, "function");
  assert.equal(typeof datalevin.ednList, "function");
  assert.equal(typeof datalevin.embeddingAttr, "function");
  assert.equal(typeof datalevin.embeddingOptions, "function");
  assert.equal(typeof datalevin.enStopWordsTokenFilter, "function");
  ...
  assert.equal(typeof datalevin.lowerCaseTokenFilter, "function");
  ...
  assert.equal(typeof datalevin.prefixTokenFilter, "function");
  assert.equal(typeof datalevin.readEdn, "function");
  assert.equal(typeof datalevin.quote, "function");
  ...
  assert.equal(typeof datalevin.txEnsure, "function");
  ...
  assert.equal(typeof datalevin.UdfDescriptor, "function");
  assert.equal(typeof datalevin.uuid, "function");
  assert.equal(typeof datalevin.Uuid, "function");
  assert.equal(typeof datalevin.EdnList, "function");
  assert.equal(typeof datalevin.FulltextOptions, "function");
  assert.equal(typeof datalevin.IdocMatchOptions, "function");
  assert.equal(typeof datalevin.VectorSearchOptions, "function");
  assert.equal(typeof datalevin.q.ednList, "function");
  assert.equal(typeof datalevin.q.quote, "function");
  assert.equal(typeof datalevin.q.fulltext, "function");
  assert.equal(typeof datalevin.q.fulltextOptions, "function");
  assert.equal(typeof datalevin.q.idocMatch, "function");
  assert.equal(typeof datalevin.q.idocMatchOptions, "function");
  assert.equal(typeof datalevin.q.vecNeighbors, "function");
  assert.equal(typeof datalevin.q.vectorSearchOptions, "function");
  assert.equal(typeof datalevin.q.udf, "function");
  assert.equal(typeof datalevin.q.bindUdf, "function");
  assert.equal(typeof datalevin.q.udfPredicate, "function");
  assert.equal(typeof datalevin.tx.callUdf, "function");
  assert.equal(typeof datalevin.tx.installUdf, "function");
  assert.equal(typeof datalevin.tx.uninstallUdf, "function");
  assert.equal(typeof datalevin.unaccentTokenFilter, "function");
  ...
  const attrPred = { ":udf/lang": ":javascript", ":udf/kind": ":predicate", ":udf/id": ":score/high?" };
  const analyzer = { ":udf/lang": ":javascript", ":udf/kind": ":analyzer", ":udf/id": ":text/hashtags" };
  const queryAnalyzer = {
    ":udf/lang": ":javascript",
    ":udf/kind": ":query-analyzer",
    ":udf/id": ":text/plain-query"
  };
  assert.deepEqual(datalevin.schemaAttr({
    ...
    embedding: true,
    embeddingDomains: ["embed"],
    embeddingAutoDomain: true,
    vectorDomains: ["vectors"],
    idocFormat: "json",
    idocDomain: "profiles",
    idocIndexedPaths: [":status"],
    idocExcludedPaths: [[":profile", ":raw"]]
  }), {
    ":db/valueType": ":db.type/string",
    ":db/unique": ":db.unique/identity",
    ":db.attr/preds": attrPred,
  ...
  assert.deepEqual(datalevin.embeddingOptions({
    ...
    embeddingMetadata: { ":source": "surface-test" },
    dimensions: 1536,
    metricType: "cosine",
    indexingMode: "async"
  }), {
  ...
  assert.deepEqual(datalevin.txEnsure(":score/high?", -1, 10), [":db/ensure", ":score/high?", -1, 10]);
