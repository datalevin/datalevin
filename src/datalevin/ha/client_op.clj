...
(ns ^:no-doc datalevin.ha.client-op
  "Helpers for idempotent HA client write retries."
  (:require
   [datalevin.bits :as b]
...
(defn tx-meta
  ...
  {:ha/client-op-id            client-op-id
   :ha/client-op-request-type  request-type
   :ha/client-op-hash          request-hash
   :ha/client-op-response-kind response-kind})
